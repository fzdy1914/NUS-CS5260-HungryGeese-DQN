...
from board_17_double_buffer import encode_observation_stack_plus
...
model.load_state_dict(torch.load('./state/double-17-ConvD3QN_3.pt', map_location=torch.device('cpu')))
model.eval()
