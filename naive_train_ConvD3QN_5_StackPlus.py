...
from model import ConvD3QN_5
from board_stack_plus import encode_state_stack_plus, encode_env_stack_plus
...
def explorer(global_rb, is_training_done, queue):
    ...
    model = ConvD3QN_5().cuda()
    target = ConvD3QN_5().cuda()
...
if __name__ == "__main__":
    ...
    torch.save(target.state_dict(), "state/ConvD3QN_5.pt")
