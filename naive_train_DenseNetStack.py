...
from board_stack import encode_state_stack, encode_env_stack
...
def explorer(global_rb, is_training_done, queue):
    ...
    model = DenseNetStack().cuda()
    target = DenseNetStack().cuda()
...
if __name__ == "__main__":
    ...
    torch.save(target.state_dict(), "state/DenseNetStack_0.pt")
